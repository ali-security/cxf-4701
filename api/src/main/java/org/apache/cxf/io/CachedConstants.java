...
public final class CachedConstants {
    ...
    /**
     * The threshold (in bytes) at which the {@code CachedOutputStream} spools to disk.
     */
    public static final String THRESHOLD_BUS_PROP =
        "bus.io.CachedOutputStream.Threshold";

    /**
     * The maximum allowed size (in bytes) for a {@code CachedOutputStream}.
     */
    public static final String MAX_SIZE_BUS_PROP =
        "bus.io.CachedOutputStream.MaxSize";

    /**
     * The cipher transformation applied to disk-backed cache files.
     */
    ...
    /**
     * Forces cleaning of the unclosed {@code CachedOutputStream} instances on Bus shutdown.
